...
public class CheckInput extends Activity{
	...
	String checkTelephone;
	   ...
	   public boolean checkup(String names,String passwords,String telephones,AlertDialog.Builder builder){
...
//密码内容验证
			public void passwordContentCheck(String passwords,AlertDialog.Builder builder){
...
//密码长度验证
	public void passwordLenghtCheck(String passwords,AlertDialog.Builder builder){	
		      char tempPass[]=passwords.toCharArray();
...
//**手机内容验证
			public void telephoneContentCheck(String telephones,AlertDialog.Builder builder){
...
//手机长度验证
	 public void telephoneLengthCheck(String telephones,AlertDialog.Builder builder){	
		       char tempTelep[]=telephones.toCharArray();
		        if(check.equals("telephoneContentRight")){
